...
const projects: { date: string, title: string, description: string, link: string }[] = [
    {
        date: "Oct 1, 2024",
        title: "UserPostify REST API",
        description: "Node.js application utilizing Express.js to provide a complete RESTful API for user management and post creation",
        link: "https://github.com/jkamin61/UserPostify"
    },
    {
        date: "Sep 10, 2023",
    ...
    },
    {
        ...
        description: "A REST API built with Node.js, Express.js and MongoDB. Documentation written with Swagger.",
...
const IndividualProjectsPage = () => {
    return (
        <div
            className="relative flex flex-col items-center pt-20 px-6 mx-auto w-full min-h-screen overflow-auto dark-theme">
            <Navigation/>
