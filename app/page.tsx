...
const Home: React.FC = () => {
  return (
      <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden dark-theme relative">
        ...
        <div className="my-16 text-center animate-fade-in">
          <h2 className="text-sm md:text-base lg:text-lg xl:text-xl text-zinc-500 mx-auto">
            ...
            <br/>This website is to present my projects
          </h2>
        </div>
      </div>
  );
